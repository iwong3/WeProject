...
function getProjectsByCategory(category){
	$.ajax({
		...
		$.each(data, function(key, data){
            ...
            output += '<a href="'+data.title+'.html">'; //change to url with parameter
            output += '<img class="img-responsive" src="../img/'+data.title+'.jpg" alt="">'; //change to url with parameter
            output += '</a>';
            output += '</div>';
